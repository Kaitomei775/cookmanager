...
* **/
	...
	/** name 磯野
	* date　2020.07.14
	* purpose rankingより、レシピ情報取得
	* function　APIを用いてレシピを取得する
	* return recipes
	* **/
	...
	/** name 磯野、鷺谷
	* date　2020.07.14
	* purpose jdbcを用いてdbに接続及びdbにレシピ情報を格納する。
	* function　それぞれの機能を用いてrecipesを作り、それをDBに入れる
	* return none
	* **/
	...
	public static void main(String[] args) throws InterruptedException {
		...
		try {
			/* データベースへの接続 */
			String url="jdbc:mysql://160.16.141.77:61000/cooksample?serverTimezone=JST";
			Class.forName("com.mysql.cj.jdbc.Driver");
			Connection con=DriverManager.getConnection(url,"test_user1","pracb2020");
